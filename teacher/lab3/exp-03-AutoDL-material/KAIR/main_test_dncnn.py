...
def main():
    ...
    parser.add_argument('--testset_name',       type=str,   default='set5',         help='test set, bsd68 | set12 | set5 | real_faces')
    ...
    # device
    if (args.device.casefold() == 'cpu'.casefold()):
        device = torch.device('cpu')
    elif ((args.device.casefold() == 'gpu'.casefold()) or (args.device.casefold() == 'cuda'.casefold())):
